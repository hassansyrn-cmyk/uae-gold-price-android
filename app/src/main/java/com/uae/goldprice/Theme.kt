...
// Backgrounds
private val DeepBackground = Color(0xFF0F0D0A)      // near-black warm charcoal
private val DeepBackgroundEnd = Color(0xFF171310)    // subtle gradient end
private val SurfaceDarkColor = Color(0xFF1C1712)     // base card surface
private val SurfaceElevatedColor = Color(0xFF241E17) // slightly raised surface
...
object GoldColors {
    ...
    // Glass card style: translucent dark surface with soft gold edge
    ...
    // Hero / ounce card premium gradient (gold -> deep emerald blend)
